const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Mr.A account',
    langGeniusAccountTip: 'Your Mr.A account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Mr.A to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Mr.A allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Mr.A\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://azure.microsoft.com/zh-cn/',
  ...
  about: {
    ...
    nowAvailable: 'Mr.A {{version}} is now available.',
    latestAvailable: 'Mr.A {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
