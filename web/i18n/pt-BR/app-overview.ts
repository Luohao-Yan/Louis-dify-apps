const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou experimente a versão em nuvem do Mr.A com cota gratuita',
  },
  overview: {
    title: 'Visão geral',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados que o aplicativo coleta, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do Mr.A.',
        },
      },
      embedded: {
        entry: 'Embutido',
        ...
        chromePlugin: 'Instalar Extensão do Chatbot Mr.A para o Chrome',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
