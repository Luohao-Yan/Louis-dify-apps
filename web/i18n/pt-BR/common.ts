const translation = {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela Mr.A permite que você use modelos como o GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros provedores de modelo.',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em aplicativos da Mr.A.',
  ...
  about: {
    ...
    nowAvailable: 'Mr.A {{version}} está disponível agora.',
    latestAvailable: 'Mr.A {{version}} é a versão mais recente disponível.',
  },
  appMenus: {
