    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados que o aplicativo coleta, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do.',
        },
      },
      embedded: {
        entry: 'Embutido',
        ...
        chromePlugin: 'Instalar Extensão do Chatbot para o Chrome',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
