const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Або спробуйте хмарну версію Mr.A з безкоштовною квотою', // Or try the cloud version ...
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Допомагає відвідувачам зрозуміти, які дані збирає програма. Дивіться <privacyPolicyLink>Політику конфіденційності</privacyPolicyLink> Mr.A.',
        },
      },
      embedded: {
        ...
        chromePlugin: 'Встановити розширення Mr.A Chatbot для Chrome',
