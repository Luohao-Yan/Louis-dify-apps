const translation = {
  ...
  welcome: 'Ласкаво просимо до Mr.A, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Mr.A Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Mr.A',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Mr.A',
